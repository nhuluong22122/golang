...
func main() {
	http.Handle("/", http.HandlerFunc(mainPage)) //can use HandleFunc
	http.Handle("/dog", http.HandlerFunc(dog)) //can use HandleFunc
	http.Handle("/me/", http.HandlerFunc(me)) //can use HandleFunc
